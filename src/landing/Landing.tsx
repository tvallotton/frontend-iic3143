...
export default function Landing() {
    ...
    return (
        <>
            <Navbar />
            <div className="flex-col justify-start items-center h-screen pt-32 w-screen">
                ...
                <div className="flex justify-center mt-4">
                    <img src={libraryImage} className="w-1/2 h-auto mt-8 rounded-md" alt="Librería" />
                </div>
                <div className="mt-8">
                    <Carousel title="Géneros populares" description="Explora los géneros más populares" items={genres} viewAllLink="#" />
                </div>
                <div className="mt-8">
                    <Carousel title="Publicaciones recientes" description="Descubre las últimas publicaciones" items={carouselPublicationItems} viewAllLink="/explore" />
                </div>
